...
const categories = [
  ...
  { id: "maintenance", label: "Maintenance", count: allServices.filter(s => s.category === "maintenance").length },
  { id: "electrical", label: "Electrical", count: allServices.filter(s => s.category === "electrical").length },
  { id: "plumbing", label: "Plumbing", count: allServices.filter(s => s.category === "plumbing").length },
  { id: "welding", label: "Welding", count: allServices.filter(s => s.category === "welding").length },
  { id: "carpentry", label: "Carpentry", count: allServices.filter(s => s.category === "carpentry").length },
  { id: "masonry", label: "Masonry", count: allServices.filter(s => s.category === "masonry").length },
  { id: "painting", label: "Painting", count: allServices.filter(s => s.category === "painting").length },
  { id: "partition", label: "Interior", count: allServices.filter(s => s.category === "partition").length },
  { id: "outdoor", label: "Outdoor", count: allServices.filter(s => s.category === "outdoor").length },
];
